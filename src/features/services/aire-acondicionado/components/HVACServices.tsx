...
import { HVACService } from "../types/hvac-detail.types";
import { CheckCircle2 } from "lucide-react";

interface HVACServicesProps {
  services: HVACService[];
}

export function HVACServices({ services }: HVACServicesProps) {
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 max-w-6xl">
        <h2 className="text-3xl font-bold text-center text-[#006989] mb-12">
          Nuestros Servicios HVAC
        </h2>
