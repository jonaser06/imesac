...
import { ContactInfo } from "../types/mantenimiento-detail.types";

interface MantenimientoContactProps {
  contact: ContactInfo;
}

export function MantenimientoContact({ contact }: MantenimientoContactProps) {
  return (
